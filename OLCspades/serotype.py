    ...
    def csvwriter(self):
        ...
        for sample in self.metadata:
            ...
            if sample.general.referencegenus == 'Escherichia':
                ...
                # Make lists of all the tuples in the dictionary with queries that, following splitting on underscore
                # have their final entry begin with O, or with H, respectively (e.g. fliC_56_AJ884569_H8 would yield H8)
                # Sort the lists based on the second entry in each tuple (reverse makes the list descending)
                ...
                try:
                    ...
                    htype = '-'
                    hidentity = ''
                # Populate the row for the repor
