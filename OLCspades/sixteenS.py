...
class SixteenS(GeneSeekr):
    ...
    def csvwriter(self):
        ...
        for sample in self.metadata:
            ...
            # The accession supplied in the blast output merges the .1 at the end AF403733.1 is displayed as AF4037331.
            # Take all the characters in the accession except the last, and add a .1 to recreate the proper accession
